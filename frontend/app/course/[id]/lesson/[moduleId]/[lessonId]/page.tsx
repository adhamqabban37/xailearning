...
export default function LessonPage() {
  ...
  const buildResourceCollections = (l: any) => {
    const pack = { youtube: [] as any[], articles: [] as any[], pdfs: [] as any[] };
    ...
    for (const item of items) {
      ...
      const isYouTube =
        /(?:youtube\.com\/watch\?v=|youtube\.com\/embed\/|youtu\.be\/)\w+/i.test(url);
          ...
          <div className="bg-gray-800 rounded-lg p-8">
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-8">
              ...
              <div>
                ...
                {/* YouTube Videos */}
                {effectiveResourcePack?.youtube && effectiveResourcePack.youtube.length > 0 && (
                          ...
                          {isExpanded && (
                            <div className="px-4 pb-4 border-t border-gray-700">
                              <div className="mt-3 text-sm text-gray-300 mb-3">
                                {video.note || "YouTube video resource to help you learn this topic."}
                              </div>
                              <a
                                href={video.url}
                                target="_blank"
                ...
                {/* Articles */}
                {effectiveResourcePack?.articles && effectiveResourcePack.articles.length > 0 && (
                  <div className="space-y-3 mb-6">
                    <h5 className="text-sm font-semibold text-gray-400 uppercase tracking-wider">
                      ...
                      return (
                        ...
                        >
                          ...
                          {isExpanded && (
                            <div className="px-4 pb-4 border-t border-gray-700">
                              <div className="mt-3 text-sm text-gray-300 mb-3">
                                {article.note || "Article or web resource for additional reading and context."}
                              </div>
                              <a
                                href={article.url}
                                target="_blank"
                ...
                {/* PDFs */}
                {effectiveResourcePack?.pdfs && effectiveResourcePack.pdfs.length > 0 && (
                      ...
                      return (
                        ...
                        >
                          ...
                          {isExpanded && (
                            <div className="px-4 pb-4 border-t border-gray-700">
                              <div className="mt-3 text-sm text-gray-300 mb-3">
                                {pdf.note || "PDF document for detailed reference and study."}
                              </div>
                              <a
                                href={pdf.url}
                                target="_blank"
