...
const analyzePdfPrompt = ai.definePrompt({
  ...
  prompt: `You are an expert instructional designer, AI learning architect, and content curator. Your task is to generate a complete, interactive, and engaging course from the provided document.
