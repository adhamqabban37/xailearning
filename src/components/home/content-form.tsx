    ...
    <Card className="w-full max-w-4xl mx-auto bg-card/80 border-accent/30 circuit-bg glow-subtle p-6 md:p-8 rounded-xl relative overflow-hidden elevation-2">
      ...
      <Form {...form}>
        <div className="space-y-6">
                    ...
                    <FormControl>
                      <div className="relative flex items-center">
                        ...
                        <Input
                          ...
                          {...field}
                          className="pl-10 text-base py-6 bg-background"
                        />
                      </div>
                    </FormControl>
                    <FormMessage />
          ...
          <div className="relative flex items-center text-muted-foreground before:h-px before:flex-1 before:bg-border after:h-px after:flex-1 after:bg-border before:mr-4 after:ml-4">
